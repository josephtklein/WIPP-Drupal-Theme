...
<iframe width="853" height="480" src="https://www.youtube.com/embed/eWf28zf62kc" frameborder="0" allowfullscreen></iframe>
      </div>
    </div>
...
<?php print $messages; ?>
<?php print $content; ?>
<p> So in the interim, have a look what your local branch is up to, many cities have a local Pirate Party Branch and their sites will not be in maintenance at the same time as the state party site.  If you don't have a local branch, head over to <a href="https://uspirates.org">the United State Pirate Party</a>.</p>
...
<p>We will try to get the site back into normal working order as soon as possible. If you have an urgent issue, you can contact the <a href="mailto:webteam@wipp.coop">IT team</a> or <a href="mailto:campaigns@wipp.coop">Campaigns team</a> directly - or call us on +1 608-237-1375 and we will try to help you out!</p>
...
<p>For more information on the Wisconsin Pirate Party, get in touch! If you wish to receive regular press statements from the Party (or no longer wish to receive them) please email the Press Office at press@wipp.coop.  You might also want to ead our Privacy Policy and our Terms of Use for this site. The  sconsin Piarte Party is a political party registered at 3425 N. Bartlett Avenue, Milwaukee, WI 53211.  Any and all original material on theis website may be freely distributed at will under the Creative Commons Attribution License, unless otherwise noted.</p>
